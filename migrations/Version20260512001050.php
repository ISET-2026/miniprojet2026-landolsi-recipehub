 ...
 */
final class Version20260512001050 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE categorie_recette (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(50) NOT NULL, icone VARCHAR(10) DEFAULT NULL, description LONGTEXT DEFAULT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('CREATE TABLE recette (id INT AUTO_INCREMENT NOT NULL, titre VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, instructions LONGTEXT NOT NULL, temps_preparation INT NOT NULL, temps_cuisson INT DEFAULT NULL, difficulte VARCHAR(20) NOT NULL, nb_personnes INT NOT NULL, date_creation VARCHAR(255) NOT NULL, publiee TINYINT NOT NULL, image_name VARCHAR(255) DEFAULT NULL, categorie_id INT DEFAULT NULL, auteur_id INT DEFAULT NULL, INDEX IDX_49BB6390BCF5E72D (categorie_id), INDEX IDX_49BB639060BB6FE6 (auteur_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, pseudo VARCHAR(50) DEFAULT NULL, UNIQUE INDEX UNIQ_IDENTIFIER_EMAIL (email), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
